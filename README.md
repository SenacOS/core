...
| [`.github/workflows/pr-labeler.yml`](./.github/workflows/pr-labeler.yml) | Workflow reutilizável de CI/CD para automação e padronização da aplicação de labels em Pull Requests. |
